              ...
              <div className="flex items-center">
                <div
                  className={cn(
                    ...
                    activeStep >= index ? ' bg-neutral-400' : 'bg-neutral-600',
                  )}
                />
              </div>
              <div
...
> = {
  ...
  loading: {
    className: 'bg-primary',
    render: <Loader2 className="text-bggg animate-spin" />,
  },
};
...
>(({ className, status = 'inactive', ...args }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        'stepper-status-icon-wrapper [&>*]:w-3 [&>*]:h-3 text-gray-200 p-1 rounded-full',
